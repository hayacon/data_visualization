function TechDiversityGender() {
    ...
    this.draw = function () {
        ...
        for (var i = 0; i < this.data.getRowCount(); i++) {
            ...
            // display a proposition of female of each company
            if (mouseX > this.layout.leftMargin &&
                mouseX < this.layout.rightMargin - this.mapPercentToWidth(company.male) &&
                ...
                fill(0);
                textSize(30);
                text(company.female, width / 3, 0);
                textSize(16);
                stroke(150);
                strokeWeight(1);
            };

            // display a proposition of male of each conmpany
            if (mouseX > this.layout.leftMargin + this.mapPercentToWidth(company.female) &&
